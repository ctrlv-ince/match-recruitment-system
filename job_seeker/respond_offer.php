...
$offer_status = $offer['status']; // Fetch the offer status
...
<body>
    ...
    <div class="container mt-5">
        <h2><i class="fas fa-handshake"></i>Respond to Job Offer</h2>
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title"><?php echo $job_title; ?></h5>
                <p class="card-text"><?php echo $offer_details; ?></p>
                <!-- Display the current status of the offer -->
                <p class="card-text"><strong>Status:</strong>
                    <span class="status-badge <?php echo $offer_status; ?>">
        ...
        <?php if ($offer_status === 'pending'): ?>
            <!-- Show the response buttons only if the offer is pending -->
            <form action="respond_offer_handler.php" method="POST">
                <input type="hidden" name="offer_id" value="<?php echo $offer_id; ?>">
                <div class="mb-3">
                    <label class="form-label">Your Response:</label>
                    <div>
                        <button type="submit" name="response" value="accepted" class="btn btn-success me-2">
        ...
        <?php else: ?>
            <!-- Show a message if the offer has already been responded to -->
            <div class="alert alert-info">
                <i class="fas fa-info-circle"></i> You have already responded to this offer.
            </div>
        <?php endif; ?>
